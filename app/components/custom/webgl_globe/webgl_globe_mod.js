/**
 * Modified Version of Globe Toolkit
 * for Zurich Population
 *
 * - Flattened
...
//        size = data[i + 2];
  ...
  function addPoint(lat, lng, size, color, subgeo) {
    ...
    point.position.y = theta; // 200 * Math.cos(phi);
    point.position.z = 0;     // 200 * Math.sin(phi) * Math.sin(theta);
